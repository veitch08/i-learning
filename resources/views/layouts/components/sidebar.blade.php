<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        @if (Auth::user()->role->slug === 'admin')
            {{-- Dashboard  --}}
            <li class="menu-item {{ $title === 'admin' ? 'active' : '' }}">
            ...
            <li class="menu-item {{ $title === 'jurusan' ? 'active' : '' }}">
            ...
            <li class="menu-item {{ $title === 'kelas' ? 'active' : '' }}">
                <a href="{{ url('/admin/kelas') }}" class="menu-link">
                    <i class="menu-icon bi bi-bank2"></i>
            ...
            <li class="menu-item {{ $title === 'guru' ? 'active' : '' }}">
                <a href="{{ url('/admin/guru') }}" class="menu-link">
                    <i class="menu-icon bi bi-person-video3"></i>
        ...
        @elseif (Auth::user()->role->slug === 'guru')
            ...
            <li class="menu-item {{ $title === 'materi' ? 'active' : '' }}">
            ...
            <li class="menu-item {{ $title === 'tugas' ? 'active' : '' }}">
                <a href="{{ url('/guru/tugas') }}" class="menu-link">
                    <i class="menu-icon bi bi-journal-text"></i>
                    <div data-i18n="Analytics">Upload Tugas</div>
                </a>
            </li> --}}
            {{-- End Tugas --}}
        @else
            ...
            <li class="menu-item {{ $title === 'materi-kelas' ? 'active' : '' }}">
                <a href="{{ url('/siswa/materi-kelas') }}" class="menu-link">
                    <i class="menu-icon bi bi-journal-bookmark"></i>
                    <div data-i18n="Analytics">Materi Pembelajaran</div>
                </a>
            </li>
            {{-- End Materi Pembelajaran --}}
        @endif
    </ul>
  </aside>
